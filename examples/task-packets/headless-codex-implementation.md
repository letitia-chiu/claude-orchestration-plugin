...
| Host-local execution authorization | NONE（headless 與 host-local scout 是不同授權） |
...
- controller 保有 immutable provenance；provider 不得推論、修改、確認或
...
- provider 只產出 substantive provider_result；runner 組合 canonical
